...
namespace Ensur.Core.Utilities
{
    ...
    public static class FileExports
    {
        ...
        /// <summary>
        /// Takes a datatable and converts it into a CSV text stream
        /// </summary>
        /// <returns></returns>
        public static Stream ToCSVStream(this DataTable dt)
        {
            ...
            MemoryStream ms = sb.ToString().ToMemoryStream();
        ...
        public static Stream CreateExcelDocument(DataTable dt)
        {
            try
            {
                DataSet ds = new DataSet();
            ...
            catch (Exception ex)
            {
                ...
                logger.Error(ex, $"Error while generating Excel document");
                throw new UserError(Resources.GENERAL_ERROR, "GENERAL_ERROR");
            }
        }

        public static Stream CreateExcelDocument<T>(List<T> list)
        {
            try
            {
                DataSet ds = new DataSet();
        ...
        public static Stream CreateExcelDocumentAsStream(DataSet ds)
        {
            try
            {
        ...
        {
            return GetCellValue(wbPart, theCells, GetExcelColumnName2(index));
        }

        private static string GetExcelColumnName2(int columnNumber)
        {
        ...
        public static DataTable GetDataTableFromExcelFile(Stream ExcelFile, string sheetName = "")
        {
            DataTable dt = new DataTable();
            try
            {
