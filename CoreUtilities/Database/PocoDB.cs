...
namespace Ensur.Core.Utilities.Database
{
    public partial class PocoDB : PetaPoco.Database
    {
        ...
        public PocoDB(string connectionStringName)
        ...
        public static PocoDB GetInstance()
        {
            if (_instance!=null)
                return _instance;
        ...
        [ThreadStatic] static PocoDB _instance;
        ...
        {
            public static PocoDB repo { get { return PocoDB.GetInstance(); } }
